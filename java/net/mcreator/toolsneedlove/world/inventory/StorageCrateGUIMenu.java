...
public class StorageCrateGUIMenu extends AbstractContainerMenu implements ToolsNeedLoveModMenus.MenuAccessor {
	...
	public StorageCrateGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToolsNeedLoveModMenus.STORAGE_CRATE_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 6) {
			...
			private int x = StorageCrateGUIMenu.this.x;
			private int y = StorageCrateGUIMenu.this.y;
		}));
