...
public class ToolsNeedLoveModTabs {
	...
	public static final RegistryObject<CreativeModeTab> TOOLS_NEED_LOVE = REGISTRY.register("tools_need_love",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tools_need_love.tools_need_love")).icon(() -> new ItemStack(ToolsNeedLoveModItems.REFINER.get())).displayItems((parameters, tabData) -> {
